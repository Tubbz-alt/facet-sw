classdef F2_CathodeServices_exported < matlab.apps.AppBase
  ...
  properties (Access = public)
    ...
    DetermineInitialCleaningEnergyButton  matlab.ui.control.Button
    ...
    ResettoStandbyButton            matlab.ui.control.Button
  ...
  methods (Access = private)
    ...
    % Button pushed function: ResettoStandbyButton
    function ResettoStandbyButtonPushed(app, event)
      app.aobj.dnCMD=true;
      resp=questdlg('Stop all operations and reset to standby mode (memory of any progress will be lost)?','Reset to Stanby Mode',...
        'Yes','No','No');
      if strcmp(resp,'Yes')
        app.aobj.CleaningLineNum=1;
        app.aobj.CleaningColNum=1;
    ...
    % DetermineInitialCleaningEnergyButton
    function DetermineInitialCleaningEnergyButtonPushed(app, event)
    ...
    function CalMotorButtonPushed(app, event)
      ...
      try
        ...
        xave_CCD=caget(app.aobj.pvs.CCD_xpos);
        yave_CCD=caget(app.aobj.pvs.CCD_ypos);
      catch
        delete(mhan);
  ...
  methods (Access = private)
    ...
    function createComponents(app)
      ...
      app.DefineCleaningAreaButton.Position = [15 337 197 30];
      ...
      app.TestCleaningSequenceButton.Position = [15 299 197 30];
      app.TestCleaningSequenceButton.Text = 'Test Cleaning Sequence';

      % Create DetermineInitialCleaningEnergyButton
      app.DetermineInitialCleaningEnergyButton = uibutton(app.LaserCleaningTab, 'push');
      app.DetermineInitialCleaningEnergyButton.ButtonPushedFcn = createCallbackFcn(app, @DetermineInitialCleaningEnergyButtonPushed, true);
      app.DetermineInitialCleaningEnergyButton.Position = [16 260 197 30];
      app.DetermineInitialCleaningEnergyButton.Text = 'Determine Initial Cleaning Energy';
      ...
      % Create ResettoStandbyButton
      app.ResettoStandbyButton = uibutton(app.LaserCleaningTab, 'push');
      app.ResettoStandbyButton.ButtonPushedFcn = createCallbackFcn(app, @ResettoStandbyButtonPushed, true);
      app.ResettoStandbyButton.BackgroundColor = [0.9294 0.6941 0.1255];
      app.ResettoStandbyButton.FontWeight = 'bold';
      app.ResettoStandbyButton.Position = [377.5 54 114 44];
      app.ResettoStandbyButton.Text = 'Reset to Standby';
      ...
      app.GrabFrameButton.Position = [38 25 114 37];
      ...
      app.ControlsButton_5.Position = [407 25 114 37];
      ...
      app.StreamImageButton.Position = [170 24 112 39];
      ...
      app.EditField_5.Position = [27 31 109 22];
      ...
      app.LaserTelescopeInsertedPanel.Position = [1393 121 170 76];
      ...
      app.SmallSpotEnabledLampLabel.Position = [11 16 111 22];
      ...
      app.SmallSpotEnabledLamp.Position = [137 16 20 20];
      ...
      app.LaserFluenceuJmm2Panel.Position = [1240 16 323 91];

      % Create Gauge_3
      app.Gauge_3 = uigauge(app.LaserFluenceuJmm2Panel, 'linear');
      app.Gauge_3.Position = [15 11 287 51];
